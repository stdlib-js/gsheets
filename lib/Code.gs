...
*/
function STDLIB_NDARRAY_ABS( x, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue, as, asValue ) { 
	var opts;
	var args;
	var out;
	var o;
	...
	args = [ ns.ndarray.range2ndarray( x ) ];
	...
	return ns.ndarray.ndarray2range( out.rawBuffer, out.capacity, out.dtype, out.shape, out.strides, out.offset, out.order, 'column' );
}
/**
