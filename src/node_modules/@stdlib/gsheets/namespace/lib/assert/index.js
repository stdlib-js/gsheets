...
var isBufferLengthCompatible = require( '@stdlib/gsheets/assert/is-buffer-length-compatible' );
...
var isValidStrides = require( '@stdlib/gsheets/assert/is-valid-strides' );
...
function namespace( dest ) {
	...
	setReadOnly( dest, 'isBufferLengthCompatible', isBufferLengthCompatible );
	...
	setReadOnly( dest, 'isValidStrides', isValidStrides );
