...
function namespace( dest ) {
	...
	setReadOnly( dest, 'ellipe', ellipe );
	setReadOnly( dest, 'ellipk', ellipk );
	setReadOnly( dest, 'erf', erf );
	setReadOnly( dest, 'erfc', erfc );
	setReadOnly( dest, 'erfcinv', erfcinv );
	setReadOnly( dest, 'erfinv', erfinv );
	setReadOnly( dest, 'exp', exp );
	setReadOnly( dest, 'exp10', exp10 );
	setReadOnly( dest, 'exp2', exp2 );
	setReadOnly( dest, 'expit', expit );
	setReadOnly( dest, 'expm1', expm1 );
	setReadOnly( dest, 'expm1rel', expm1rel );
