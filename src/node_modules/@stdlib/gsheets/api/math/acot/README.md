...
> Compute the inverse cotangent of a number (in radians).
...
```javascript
var acot = require( '@stdlib/gsheets/api/math/acot' );
```

#### acot( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
