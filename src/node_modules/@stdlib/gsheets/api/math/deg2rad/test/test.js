...
var ref = require( '@stdlib/math-base-special-deg2rad' );
...
tape( 'the function converts an angle from degrees to radians (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function converts an angle from degrees to radians (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
