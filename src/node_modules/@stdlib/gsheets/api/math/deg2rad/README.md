...
```javascript
var deg2rad = require( '@stdlib/gsheets/api/math/deg2rad' );
```

#### deg2rad( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( -360.0, 360.0 ) );
console.log( x );
