...
var ref = require( '@stdlib/math-base-special-cosh' );
...
tape( 'the function computes the hyperbolic cosine of a number (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the hyperbolic cosine of a number (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
