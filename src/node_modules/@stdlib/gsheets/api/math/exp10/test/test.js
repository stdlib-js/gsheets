...
var ref = require( '@stdlib/math-base-special-exp10' );
...
tape( 'the function evaluates the base 10 exponential function (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function evaluates the base 10 exponential function (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
