...
```javascript
var ahavercos = require( '@stdlib/gsheets/api/math/ahavercos' );
```

#### ahavercos( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( 0.0, 1.0 ) );
console.log( x );
