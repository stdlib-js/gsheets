...
```javascript
var binet = require( '@stdlib/gsheets/api/math/binet' );
```

#### binet( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( 0.0, 79.0 ) );
console.log( x );
