...
> Round a number to the nearest power of 2 toward positive infinity.
...
```javascript
var ceil2 = require( '@stdlib/gsheets/api/math/ceil2' );
```

#### ceil2( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
