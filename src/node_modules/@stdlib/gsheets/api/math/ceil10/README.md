...
> Round a number to the nearest power of 10 toward positive infinity.
...
```javascript
var ceil10 = require( '@stdlib/gsheets/api/math/ceil10' );
```

#### ceil10( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( -50.0, 50.0 ) );
console.log( x );
