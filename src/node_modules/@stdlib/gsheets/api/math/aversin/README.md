...
```javascript
var aversin = require( '@stdlib/gsheets/api/math/aversin' );
```

#### aversin( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
