...
```javascript
var ellipe = require( '@stdlib/gsheets/api/math/ellipe' );
```

#### ellipe( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
