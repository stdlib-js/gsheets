...
var ref = require( '@stdlib/math-base-special-pow' );
...
var rand1 = prng1( 0.0, 100.0 );
var rand2 = prng2( -10.0, 10.0 );
...
tape( 'the function evaluates the exponential function (primitive)', function test( t ) {
	var expected;
	var actual;
	var out;
	var v1;
...
tape( 'the function evaluates the exponential function (nested array)', function test( t ) {
	var expected;
	var actual;
	var X1;
	var X2;
...
tape( 'the function evaluates the exponential function (nested array; broadcasting)', function test( t ) {
	var expected;
	var actual;
	var X1;
	var x1;
