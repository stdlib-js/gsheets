...
> Evaluate the Riemann zeta function as a function of a real variable.
...
```javascript
var zeta = require( '@stdlib/gsheets/api/math/riemann-zeta' );
```

#### zeta( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( 1.1, 10.0 ) );
console.log( x );
