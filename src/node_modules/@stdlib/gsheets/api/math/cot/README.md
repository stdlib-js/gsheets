...
```javascript
var cot = require( '@stdlib/gsheets/api/math/cot' );
```

#### cot( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( -1.57, 1.57 ) );
console.log( x );
