...
var ref = require( '@stdlib/math-base-special-cot' );
...
tape( 'the function evaluates the cotangent of a number (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function evaluates the cotangent of a number (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
