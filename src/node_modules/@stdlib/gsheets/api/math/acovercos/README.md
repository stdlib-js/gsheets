...
```javascript
var acovercos = require( '@stdlib/gsheets/api/math/acovercos' );
```

#### acovercos( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( -2.0, 0.0 ) );
console.log( x );
