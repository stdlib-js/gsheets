...
```javascript
var besselj0 = require( '@stdlib/gsheets/api/math/besselj0' );
```

#### besselj0( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
