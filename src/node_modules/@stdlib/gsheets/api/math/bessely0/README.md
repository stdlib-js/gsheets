...
```javascript
var bessely0 = require( '@stdlib/gsheets/api/math/bessely0' );
```

#### bessely0( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( 0.0, 10.0 ) );
console.log( x );
