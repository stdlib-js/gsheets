...
> Round a number to the nearest multiple of 10^n toward negative infinity.
...
```javascript
var floorn = require( '@stdlib/gsheets/api/math/floorn' );
```

#### floorn( x, y\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, prng1( -10.0, 10.0 ) );
console.log( x );

var y = filled2dBy( shape, prng2( -10, 0 ) );
console.log( y );
