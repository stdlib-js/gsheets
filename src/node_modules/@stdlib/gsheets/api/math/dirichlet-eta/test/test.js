...
var ref = require( '@stdlib/math-base-special-dirichlet-eta' );
...
tape( 'the function evaluates the Dirichlet eta function (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function evaluates the Dirichlet eta function (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
