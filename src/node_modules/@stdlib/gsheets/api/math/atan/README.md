...
```javascript
var atan = require( '@stdlib/gsheets/api/math/atan' );
```

#### atan( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( -2.0, 2.0 ) );
console.log( x );
