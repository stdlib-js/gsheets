...
var ref = require( '@stdlib/math-base-special-covercos' );
...
tape( 'the function computes the coversed cosine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the coversed cosine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
