...
```javascript
var covercos = require( '@stdlib/gsheets/api/math/covercos' );
```

#### covercos( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
