...
```javascript
var acoversin = require( '@stdlib/gsheets/api/math/acoversin' );
```

#### acoversin( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( 0.0, 2.0 ) );
console.log( x );
