...
```javascript
var ellipk = require( '@stdlib/gsheets/api/math/ellipk' );
```

#### ellipk( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( -10.0, 1.0 ) );
console.log( x );
