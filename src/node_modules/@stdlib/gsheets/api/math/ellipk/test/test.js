...
var ref = require( '@stdlib/math-base-special-ellipk' );
...
tape( 'the function computes the complete elliptic integral of the first kind (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the complete elliptic integral of the first kind (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
