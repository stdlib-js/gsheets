...
var ref = require( '@stdlib/math-base-special-coversin' );
...
tape( 'the function computes the coversed sine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the coversed sine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
