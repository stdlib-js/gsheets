...
var ref = require( '@stdlib/math-base-special-expit' );
...
tape( 'the function computes the standard logistic function (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the standard logistic function (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
