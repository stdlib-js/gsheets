...
```javascript
var bessely1 = require( '@stdlib/gsheets/api/math/bessely1' );
```

#### bessely1( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
