...
```javascript
var avercos = require( '@stdlib/gsheets/api/math/avercos' );
```

#### avercos( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
