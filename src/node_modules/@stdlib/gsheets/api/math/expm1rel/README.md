...
```javascript
var expm1rel = require( '@stdlib/gsheets/api/math/expm1rel' );
```

#### expm1rel( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
