...
var ref = require( '@stdlib/math-base-special-expm1rel' );
...
tape( 'the function computes the relative error exponential (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the relative error exponential (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
