...
```javascript
var ahaversin = require( '@stdlib/gsheets/api/math/ahaversin' );
```

#### ahaversin( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
