...
> Compute the cosine of a number times π.
...
```javascript
var cospi = require( '@stdlib/gsheets/api/math/cospi' );
```

#### cospi( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
