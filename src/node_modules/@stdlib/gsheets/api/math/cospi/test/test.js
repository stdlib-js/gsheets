...
var ref = require( '@stdlib/math-base-special-cospi' );
...
tape( 'the function computes the cosine of a number times π (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the cosine of a number times π (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
