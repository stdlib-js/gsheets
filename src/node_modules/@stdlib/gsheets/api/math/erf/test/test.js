...
var ref = require( '@stdlib/math-base-special-erf' );
...
tape( 'the function evaluates the error function (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function evaluates the error function (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
