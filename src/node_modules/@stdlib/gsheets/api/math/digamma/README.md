...
```javascript
var digamma = require( '@stdlib/gsheets/api/math/digamma' );
```

#### digamma( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( 1.0, 10.0 ) );
console.log( x );
