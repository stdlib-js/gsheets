...
var ref = require( '@stdlib/math-base-special-digamma' );
...
tape( 'the function evaluates the digamma function (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function evaluates the digamma function (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
