...
var ref = require( '@stdlib/math-base-special-cosm1' );
...
tape( 'the function computes cos(x)-1 (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes cos(x)-1 (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
