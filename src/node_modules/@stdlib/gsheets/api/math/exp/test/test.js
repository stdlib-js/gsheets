...
var ref = require( '@stdlib/math-base-special-exp' );
...
tape( 'the function evaluates the natural exponential function (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function evaluates the natural exponential function (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
