...
var ref = require( '@stdlib/math-base-special-erfinv' );
...
tape( 'the function evaluates the inverse error function (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function evaluates the inverse error function (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
