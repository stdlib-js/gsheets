...
```javascript
var erfinv = require( '@stdlib/gsheets/api/math/erfinv' );
```

#### erfinv( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( -0.9, 0.9 ) );
console.log( x );
