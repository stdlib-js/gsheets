...
```javascript
var besselj1 = require( '@stdlib/gsheets/api/math/besselj1' );
```

#### besselj1( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
