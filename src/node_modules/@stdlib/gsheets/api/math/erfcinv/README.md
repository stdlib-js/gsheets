...
```javascript
var erfcinv = require( '@stdlib/gsheets/api/math/erfcinv' );
```

#### erfcinv( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
