...
var ref = require( '@stdlib/math-base-special-expm1' );
...
tape( 'the function computes exp(x)-1, where exp(x) is the natural exponential function (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes exp(x)-1, where exp(x) is the natural exponential function (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
