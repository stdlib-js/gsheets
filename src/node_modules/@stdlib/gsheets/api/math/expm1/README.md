...
> Compute exp(x)-1, where exp(x) is the natural exponential function.
...
```javascript
var expm1 = require( '@stdlib/gsheets/api/math/expm1' );
```

#### expm1( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
...
var x = filled2dBy( shape, uniform( -5.0, 5.0 ) );
console.log( x );
