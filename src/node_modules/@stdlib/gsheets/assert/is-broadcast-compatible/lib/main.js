...
var base = require( '@stdlib/gsheets/assert/base/is-broadcast-compatible' );
...
*
* try {
*     isBroadcastCompatible( x, y, 'First and second arguments' );
* } catch ( error ) {
*     console.error( error.message );
* }
*/
function isBroadcastCompatible( x, y, msg ) {
	if ( base( x, y ) ) {
		return;
	}
