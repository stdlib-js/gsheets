...
function stacked1d( x ) {
	...
	return out.concat( ndarray2array( x.ndarray, [ x.length, 1 ], [ 1, 1 ], 0, 'row-major' ) ); // TODO: replace with @stdlib/array/base equivalent
}
...
function ndarray2rows( x ) {
	return ndarray2array( x.data, x.shape, x.strides, x.offset, x.order ); // TODO: replace with @stdlib/array/base equivalent
}
