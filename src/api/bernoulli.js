...
*/
function STDLIB_BERNOULLI( value, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue ) { // eslint-disable-line no-unused-vars
	var opts;
	var f;
	var o;
	var i;
	...
	f = ns.tools.d_d( ns.bernoulli, opts );
	if ( ns.isArray( value ) ) {
...
module.exports = STDLIB_BERNOULLI;
