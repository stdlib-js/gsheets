...
*/
function STDLIB_BINET( value, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue ) { // eslint-disable-line no-unused-vars
	var opts;
	var f;
	var o;
	var i;
	...
	f = ns.math.tools.d_d( ns.binet, opts );
	if ( ns.isArray( value ) ) {
