...
var __STDLIB_ADD_DTYPES = [ 'number', 'number' ]; // eslint-disable-line no-underscore-dangle
var __STDLIB_ADD_MSGS = [ 'First argument', 'Second argument' ]; // eslint-disable-line no-underscore-dangle
