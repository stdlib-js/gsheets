...
*/
function STDLIB_CEIL10( value, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue ) { // eslint-disable-line no-unused-vars
	var opts;
	var f;
	var o;
	var i;
	...
	f = ns.math.tools.d_d( ns.ceil10, opts );
	if ( ns.isArray( value ) ) {
