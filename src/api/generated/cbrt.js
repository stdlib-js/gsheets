...
*/
function STDLIB_CBRT( value, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue ) { // eslint-disable-line no-unused-vars
	var opts;
	var f;
	var o;
	var i;
	...
	f = ns.math.tools.d_d( ns.cbrt, opts );
	if ( ns.isArray( value ) ) {
