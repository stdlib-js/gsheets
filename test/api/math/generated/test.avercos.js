...
var ref = require( '@stdlib/math-base-special-avercos' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var avercos = require( '@stdlib/gsheets/api/math/generated/avercos.js' );
...
tape( 'the function computes the inverse versed cosine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the inverse versed cosine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
