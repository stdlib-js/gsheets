...
var ref = require( '@stdlib/math-base-special-acosh' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var acosh = require( '@stdlib/gsheets/api/math/generated/acosh.js' );
...
tape( 'the function computes the hyperbolic arccosine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the hyperbolic arccosine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
