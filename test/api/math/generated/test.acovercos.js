...
var acovercos = require( '@stdlib/gsheets/api/math/generated/acovercos.js' );
...
tape( 'the function computes the inverse coversed cosine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the inverse coversed cosine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
