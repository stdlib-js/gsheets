...
var ref = require( '@stdlib/math-base-special-cbrt' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var cbrt = require( '@stdlib/gsheets/api/math/generated/cbrt.js' );
...
tape( 'the function computes the cube root (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the cube root (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
