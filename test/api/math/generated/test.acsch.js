...
var ref = require( '@stdlib/math-base-special-acsch' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var acsch = require( '@stdlib/gsheets/api/math/generated/acsch.js' );
...
tape( 'the function computes the hyperbolic arccosecant (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the hyperbolic arccosecant (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
