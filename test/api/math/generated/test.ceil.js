...
var ref = require( '@stdlib/math-base-special-ceil' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var ceil = require( '@stdlib/gsheets/api/math/generated/ceil.js' );
...
tape( 'the function rounds a number toward positive infinity (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function rounds a number toward positive infinity (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
