...
var ref = require( '@stdlib/math-base-special-aversin' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var aversin = require( '@stdlib/gsheets/api/math/generated/aversin.js' );
...
tape( 'the function computes the inverse versed sine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the inverse versed sine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
