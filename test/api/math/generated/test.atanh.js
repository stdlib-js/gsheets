...
var ref = require( '@stdlib/math-base-special-atanh' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var atanh = require( '@stdlib/gsheets/api/math/generated/atanh.js' );
...
tape( 'the function computes the hyperbolic arctangent (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the hyperbolic arctangent (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
