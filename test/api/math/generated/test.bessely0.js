...
var ref = require( '@stdlib/math-base-special-bessely0' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var bessely0 = require( '@stdlib/gsheets/api/math/generated/bessely0.js' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof bessely0, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function computes the Bessel function of the second kind of order zero (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the Bessel function of the second kind of order zero (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
