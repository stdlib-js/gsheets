...
var ref = require( '@stdlib/math-base-special-besselj1' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var besselj1 = require( '@stdlib/gsheets/api/math/generated/besselj1.js' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof besselj1, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function computes the Bessel function of the first kind of order one (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the Bessel function of the first kind of order one (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
