...
var ref = require( '@stdlib/math-base-ops-sub' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var sub = require( '@stdlib/gsheets/api/math/generated/sub.js' );
...
tape( 'the function performs subtraction (primitive)', function test( t ) {
	var expected;
	var actual;
	var out;
	var v1;
...
tape( 'the function performs subtraction (nested array)', function test( t ) {
	var expected;
	var actual;
	var X1;
	var X2;
...
tape( 'the function performs subtraction (nested array; broadcasting)', function test( t ) {
	var expected;
	var actual;
	var X1;
	var x1;
