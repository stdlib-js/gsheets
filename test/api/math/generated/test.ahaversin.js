...
var ref = require( '@stdlib/math-base-special-ahaversin' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var ahaversin = require( '@stdlib/gsheets/api/math/generated/ahaversin.js' );
...
tape( 'the function computes the inverse half-value versed sine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the inverse half-value versed sine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
