...
var abs = require( '@stdlib/gsheets/api/math/generated/abs.js' );
...
tape( 'the function computes the absolute value (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the absolute value (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
