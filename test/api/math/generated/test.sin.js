...
var ref = require( '@stdlib/math-base-special-sin' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var sin = require( '@stdlib/gsheets/api/math/generated/sin.js' );
...
tape( 'the function computes the sine of a number (in radians) (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the sine of a number (in radians) (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
