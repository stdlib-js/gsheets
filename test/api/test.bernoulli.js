...
tape( 'the function computes the nth Bernoulli number (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the nth Bernoulli number (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
