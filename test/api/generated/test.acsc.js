...
var ref = require( '@stdlib/math-base-special-acsc' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var acsc = require( './../../../src/api/generated/acsc.js' );
...
tape( 'the function computes the arccosecant (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the arccosecant (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
