...
var ref = require( '@stdlib/math-base-special-ahavercos' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( './../../../src/utils/flatten2d.js' );
var ahavercos = require( './../../../src/api/generated/ahavercos.js' );
...
tape( 'the function computes the inverse half-value versed cosine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the inverse half-value versed cosine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
