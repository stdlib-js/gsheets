...
var ref = require( '@stdlib/math-base-special-acot' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/utils/flatten2d' );
var acot = require( './../../../src/api/generated/acot.js' );
...
tape( 'the function computes the inverse cotangent of a number (in radians) (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the inverse cotangent of a number (in radians) (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
