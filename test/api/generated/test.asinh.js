...
var ref = require( '@stdlib/math-base-special-asinh' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( './../../../src/utils/flatten2d.js' );
var asinh = require( './../../../src/api/generated/asinh.js' );
...
tape( 'the function computes the hyperbolic arcsine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the hyperbolic arcsine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
