...
var ref = require( '@stdlib/math-base-special-riemann-zeta' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/utils/flatten2d' );
var zeta = require( './../../../src/api/generated/zeta.js' );


// VARIABLES //

var rand = uniform( 1.1, 10.0 );
...
tape( 'the function evaluates the Riemann zeta function as a function of a real variable (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function evaluates the Riemann zeta function as a function of a real variable (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
