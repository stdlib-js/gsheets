...
var ref = require( '@stdlib/math-base-special-atan' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/utils/flatten2d' );
var atan = require( './../../../src/api/generated/atan.js' );
...
tape( 'the function computes the arctangent of a number (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the arctangent of a number (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
