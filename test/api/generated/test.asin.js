...
var ref = require( '@stdlib/math-base-special-asin' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( './../../../src/utils/flatten2d.js' );
var asin = require( './../../../src/api/generated/asin.js' );
...
tape( 'the function computes the arcsine of a number (in radians) (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the arcsine of a number (in radians) (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
