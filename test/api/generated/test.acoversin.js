...
var ref = require( '@stdlib/math-base-special-acoversin' );
var isArray = require( '@stdlib/assert-is-array' );
var uniform = require( '@stdlib/random-base-uniform' ).factory;
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var acoversin = require( './../../../src/api/generated/acoversin.js' );
...
tape( 'the function computes the inverse coversed sine (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the inverse coversed sine (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
