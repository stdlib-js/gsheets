...
var kebabcase = require( '@stdlib/gsheets/api/string/generated/kebabcase.js' );
...
tape( 'the function converts a string to kebab case (primitive)', function test( t ) {
	var expected;
	var actual;
	var values;
	var v;
...
tape( 'the function converts a string to kebab case (nested array)', function test( t ) {
	var expected;
	var actual;
	var values;
	var arr;
