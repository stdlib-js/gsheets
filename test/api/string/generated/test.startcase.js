...
var ref = require( '@stdlib/string-startcase' );
var isArray = require( '@stdlib/assert-is-array' );
var flatten2d = require( '@stdlib/gsheets/array/flatten2d' );
var startcase = require( '@stdlib/gsheets/api/string/generated/startcase.js' );
...
tape( 'the function converts a string to start case (primitive)', function test( t ) {
	var expected;
	var actual;
	var values;
	var v;
...
tape( 'the function converts a string to start case (nested array)', function test( t ) {
	var expected;
	var actual;
	var values;
	var arr;
