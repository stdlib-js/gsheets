...
var constantcase = require( '@stdlib/gsheets/api/string/generated/constantcase.js' );
...
tape( 'the function converts a string to constant case (primitive)', function test( t ) {
	var expected;
	var actual;
	var values;
	var v;
...
tape( 'the function converts a string to constant case (nested array)', function test( t ) {
	var expected;
	var actual;
	var values;
	var arr;
