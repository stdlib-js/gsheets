...
tape( 'the function converts a string to camel case (primitive)', function test( t ) {
	var expected;
	var actual;
	var values;
	var v;
...
tape( 'the function converts a string to camel case (nested array)', function test( t ) {
	var expected;
	var actual;
	var values;
	var arr;
