...
var uncapitalize = require( '@stdlib/gsheets/api/string/generated/uncapitalize.js' );
...
tape( 'the function lowercases the first character of a string (primitive)', function test( t ) {
	var expected;
	var actual;
	var values;
	var v;
...
tape( 'the function lowercases the first character of a string (nested array)', function test( t ) {
	var expected;
	var actual;
	var values;
	var arr;
