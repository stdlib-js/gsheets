...
var lowercase = require( '@stdlib/gsheets/api/string/generated/lowercase.js' );
...
tape( 'the function converts a string to lowercase (primitive)', function test( t ) {
	var expected;
	var actual;
	var values;
	var v;
...
tape( 'the function converts a string to lowercase (nested array)', function test( t ) {
	var expected;
	var actual;
	var values;
	var arr;
