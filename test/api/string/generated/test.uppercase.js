...
var uppercase = require( '@stdlib/gsheets/api/string/generated/uppercase.js' );
...
tape( 'the function converts a string to uppercase (primitive)', function test( t ) {
	var expected;
	var actual;
	var values;
	var v;
...
tape( 'the function converts a string to uppercase (nested array)', function test( t ) {
	var expected;
	var actual;
	var values;
	var arr;
